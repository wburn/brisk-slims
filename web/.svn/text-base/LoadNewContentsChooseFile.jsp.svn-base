<%--
    Document   : LoadNewContentsChooseFile
...
<%String lapasId = "LoadNewContentsChooseFile";%>
...
<table class="spaced" style="color:grey"><tr>
                    <td style="font-weight:bold">Select a file:
                    <input class="button" type="file" name="fileToLoad" disabled>
                        </td>
</tr></table>
<table class="spaced"><tr><td><input class="button" type="submit" value="Next" disabled></td>
                    <td>
                        <input class="button" type="button" value="Cancel" disabled onclick="return gotoIndex();"></td>
</tr></table>
...
<fieldset>
        <table class="navigate" >
                 <tr><th colspan="2">2. Specific Samples File</th></tr>
                    ...
                    <tr><td>Row</td><td>The row in the container the sample is in (ex "B")</td></tr>
                    <tr><td>Column</td><td>The column in the container the sample is in (ex "12")</td></tr>
                    <tr><td>Sample ID</td><td>(ex: Az1001-1a or SAGE1234)</td></tr>
...
<table class="spaced"><tr>
                    <td style="font-weight:bold">Select a file:
                    <input class="button" type="file" name="contentFileToLoad" id="contentFileToLoad" >
                        </td>
</tr></table>
