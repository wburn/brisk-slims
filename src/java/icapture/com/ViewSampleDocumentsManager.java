 ...
 * @author ATan1
 */
public final class ViewSampleDocumentsManager {
    private int          first;
    ...
    public ViewSampleDocumentsManager(UserHttpSess tmpHttpSessObj) {
    ...
    public void changeSampleDocumentsTotal(int diff) {
        total += diff;
    }

    public void setSampleDocumentsCount(int val) {
        total = val;
    }

    public boolean hasSampleDocumentsPrevious() {
        return (step > 0) && (first > 0);
    }

    public void setSampleDocumentsPrevious() {
        first -= step;
    ...
    public boolean hasSampleDocumentsNext() {
        return (step > 0) && (first + step < total - 1);
    }

    public void setSampleDocumentsNext() {
        first += step;

        if (first >= total) {
            setSampleDocumentsPrevious();
        }
    }

    public void setSampleDocumentsFirst() {
        first = 0;
    }

    public void setSampleDocumentsLast() {
        first = total - step;
    ...
    public int getSampleDocumentsStep() {
        return step;
    }

    public int getSampleDocumentsCurrent() {
        return first;
    }

    public String getSampleDocumentsControlString() {
