...
public final class ViewMaterialTypeManager {
    private int          first;
    ...
    public ViewMaterialTypeManager(UserHttpSess tmpHttpSessObj) {
    ...
    public void changeMaterialTypeTotal(int diff) {
        total += diff;
    }

    public void setMaterialTypeCount(int val) {
        materialtypeCount = val;

        if (total < materialtypeCount) {
            total = materialtypeCount;
        }
    }

    public boolean hasMaterialTypePrevious() {
        return (step > 0) && (first > 0);
    }

    public void setMaterialTypePrevious() {
        first -= step;
    ...
    public boolean hasMaterialTypeNext() {
        return (step > 0) && (first + step < total - 1);
    }

    public void setMaterialTypeNext() {
        first += step;

        if (first >= total) {
            setMaterialTypePrevious();
        }
    }

    public void setMaterialTypeFirst() {
        first = 0;
    }

    public void setMaterialTypeLast() {
        first = total - step;
    ...
    public int getMaterialTypeStep() {
        return step;
    }

    public int getMaterialTypeCurrent() {
        return first;
    }

    public String getMaterialTypeControlString() {
